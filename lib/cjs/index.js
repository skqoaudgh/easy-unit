...
var parseValueToUnit = function parseValueToUnit(value) {
...
var isValidUnit = function isValidUnit(unit) {
  var isWeightUnit = Object.values(WEIGHT).some(function (values) {
    return Object.keys(values).includes(unit);
  });
  if (isWeightUnit) {
    return true;
  }
  return Object.values(FORMULA).some(function (values) {
    return Object.keys(values).includes(unit);
  });
};
...
var Converter = /*#__PURE__*/function () {
  function Converter() {
    ...
    _classPrivateFieldSet(this, _unit, parseValueToUnit(value) || unit);
    _classPrivateFieldSet(this, _base, parseFloat(String(value)));
  }
  _createClass(Converter, [{
    key: "unit",
    get: function get() {
      return _classPrivateFieldGet(this, _unit);
    },
    set: function set(unit) {
      if (typeof unit !== 'string') {
        throw new Error('parameter unit expected a string');
      }
      _classPrivateFieldSet(this, _unit, unit);
      return unit;
    }
  }, {
    key: "getUnit",
    ...
    key: "base",
    get: function get() {
      return _classPrivateFieldGet(this, _base);
    },
    ...
    value: function set() {
      ...
      _classPrivateFieldSet(this, _unit, parseValueToUnit(value) || unit);
      _classPrivateFieldSet(this, _base, parseFloat(String(value)));
      return "".concat(_classPrivateFieldGet(this, _unit)).concat(_classPrivateFieldGet(this, _base));
    }
  }, {
    key: "isValid",
    value: function isValid() {
      ...
      var unit = parseValueToUnit(value) || '';
      return unit ? !!getSystem(_classPrivateFieldGet(this, _unit), unit) : isValidUnit(_classPrivateFieldGet(this, _unit));
    }
  }, {
    key: "to",
    value: function to(unit) {
      ...
      _classPrivateFieldSet(this, _base, value);
      _classPrivateFieldSet(this, _unit, unit);
    ...
    value: function add(value) {
      var _ref5 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        _ref5$digit = _ref5.digit,
        digit = _ref5$digit === void 0 ? null : _ref5$digit,
        _ref5$printUnit = _ref5.printUnit,
        printUnit = _ref5$printUnit === void 0 ? true : _ref5$printUnit;
      if (typeof value !== 'string') {
        throw new Error('parameter printUnit expected a string');
      }
      var unit = parseValueToUnit(value) || _classPrivateFieldGet(this, _unit);
      var system = getSystem(_classPrivateFieldGet(this, _unit), unit);
      if (!system) {
        throw new Error('parameter expected a same system with base unit');
      }
    ...
    value: function subtract(value) {
      var _ref6 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        _ref6$digit = _ref6.digit,
        digit = _ref6$digit === void 0 ? null : _ref6$digit,
        _ref6$printUnit = _ref6.printUnit,
        printUnit = _ref6$printUnit === void 0 ? true : _ref6$printUnit;
      if (typeof value !== 'string') {
        throw new Error('parameter printUnit expected a string');
      }
      var unit = parseValueToUnit(value) || _classPrivateFieldGet(this, _unit);
    ...
    value: function toString() {
      var _ref7 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref7$digit = _ref7.digit,
        digit = _ref7$digit === void 0 ? null : _ref7$digit,
        _ref7$printUnit = _ref7.printUnit,
        printUnit = _ref7$printUnit === void 0 ? true : _ref7$printUnit;
      ...
      var base = !digit ? _classPrivateFieldGet(this, _base) : Number(_classPrivateFieldGet(this, _base)).toFixed(digit);
      return !printUnit ? Number(base) : "".concat(base).concat(_classPrivateFieldGet(this, _unit));
    }
  }]);
  return Converter;
}();
